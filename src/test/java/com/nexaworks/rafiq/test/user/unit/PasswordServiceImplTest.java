...
class PasswordServiceImplTest {
    ...
    class ForgetPasswordTests {
        ...
        void shouldGenerateAccessTokenAndPublishEventWhenUserExists() {
            ...
            assertThat(event.email()).isEqualTo(testUser.getEmail());
            assertThat(event.accessToken()).isEqualTo(generatedToken);
            assertThat(event.name()).isEqualTo(testUser.getFirstName());
        }
    ...
    class ChangePasswordTests {
        ...
        @Test
        @DisplayName("Should throw exception when access token is not found")
        void shouldThrowExceptionWhenAccessTokenIsNotFound() {
            // Arrange
            ...
            // Act & Assert
            assertThatThrownBy(() -> passwordService.changePassword(request))
                    .isInstanceOf(com.nexaworks.rafiq.user.exception.TokenNotFoundException.class);
