    ...
    class Refresh {
        ...
        class ShouldFailRefresh {
            ...
            void shouldReturnNotFoundWhenRefreshTokenDoesNotExist() throws Exception {
                ...
                // Act & Assert - Should return 404 for non-existent token
                mockMvc.perform(
                        MockMvcRequestBuilders.post(REFRESH_ENDPOINT).cookie(refreshTokenCookie))
            ...
            void shouldReturnNotFoundWhenRefreshTokenIsEmpty() throws Exception {
                ...
                // Act & Assert - Should return 404 for empty refresh token
                mockMvc.perform(MockMvcRequestBuilders.post(REFRESH_ENDPOINT)
