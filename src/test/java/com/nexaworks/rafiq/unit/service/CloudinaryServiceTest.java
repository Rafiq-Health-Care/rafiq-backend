...
class CloudinaryServiceTest {
  ...
  void shouldThrowExceptionWhenFileIsEmpty() {
    ...
    assertThrows(
        EmptyFileException.class, () -> cloudinaryService.uploadResource(file, UploadType.IMAGE));
  }
  ...
  void shouldThrowExceptionWhenUploadFails() throws IOException {
    ...
    assertThrows(
        FileUploadException.class, () -> cloudinaryService.uploadResource(file, UploadType.IMAGE));
  }
