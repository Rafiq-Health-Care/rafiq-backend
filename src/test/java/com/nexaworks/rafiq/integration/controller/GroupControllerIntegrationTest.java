...
public class GroupControllerIntegrationTest extends BaseIntegrationTest {
    ...
    class AddGroupTests {
        private final String ADD_GROUP_ENDPOINT = "/api/v1/group";
        ...
        void shouldAddGroup_WhenRequestIsValid() throws Exception {
            ...
            AddGroupRequest request = new AddGroupRequest("Pain Relief",
                    "Medications for pain management", "#0000FF");
            String payload = objectMapper.writeValueAsString(request);

            mockMvc.perform(MockMvcRequestBuilders.post(ADD_GROUP_ENDPOINT)
                    .contentType(MediaType.APPLICATION_JSON).content(payload)
                    .header("Idempotency-Key", UUID.randomUUID().toString()).with(withUserId(user)))
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$.data.color").value("#0000FF"))
        ...
        void shouldReturnConflict_WhenGroupNameAlreadyExists() throws Exception {
            ...
            AddGroupRequest request = new AddGroupRequest("Vitamins",
                    "Daily vitamins and supplements", "#0000FF");
            String payload = objectMapper.writeValueAsString(request);
    ...
    class GetAllGroupsTests {
        private final String GET_ALL_GROUPS_ENDPOINT = "/api/v1/group";
        ...
        void shouldReturnGroupsSortedDescending_WhenDirectionIsDesc() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group1 = com.nexaworks.rafiq.entities.Group.builder()
                    .name("A-Group").description("First alphabetically").color(Color.RED.name())
                    .patient((Patient) user).build();

            com.nexaworks.rafiq.entities.Group group2 = com.nexaworks.rafiq.entities.Group.builder()
                    .name("C-Group").description("Third alphabetically").color(Color.GREEN.name())
                    .patient((Patient) user).build();

            com.nexaworks.rafiq.entities.Group group3 = com.nexaworks.rafiq.entities.Group.builder()
                    .name("B-Group").description("Second alphabetically").color(Color.BLUE.name())
                    .patient((Patient) user).build();
    ...
    class GetGroupByIdTests {
        private final String GET_GROUP_BY_ID_ENDPOINT = "/api/v1/group/";
        ...
        void shouldReturnNotFound_WhenGroupBelongsToDifferentUser() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group = com.nexaworks.rafiq.entities.Group.builder()
                    .name("User1 Group").description("Group belonging to user1")
                    .color(Color.BLUE.name()).patient((Patient) user1).build();
    ...
    class UpdateGroupTests {
        private final String UPDATE_GROUP_ENDPOINT = "/api/v1/group/";
        ...
        void shouldUpdateGroup_WhenRequestIsValid() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group = com.nexaworks.rafiq.entities.Group.builder()
                    .name("Old Name").description("Old Description").color(Color.RED.name())
                    .patient((Patient) user).build();
        ...
        void shouldReturnConflict_WhenUpdatingToExistingGroupName() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group1 = com.nexaworks.rafiq.entities.Group.builder()
                    .name("Existing Group").description("Description").color(Color.RED.name())
                    .patient((Patient) user).build();

            com.nexaworks.rafiq.entities.Group group2 = com.nexaworks.rafiq.entities.Group.builder()
                    .name("Group to Update").description("Description").color(Color.BLUE.name())
                    .patient((Patient) user).build();
    ...
    class DeleteGroupTests {
        private final String DELETE_GROUP_ENDPOINT = "/api/v1/group/";
        ...
        void shouldDeleteGroup_WhenGroupExists() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group = com.nexaworks.rafiq.entities.Group.builder()
                    .name("Group to Delete").description("Will be deleted").color(Color.RED.name())
                    .patient((Patient) user).build();
        ...
        void shouldReturnNotFound_WhenDeletingGroupOfDifferentUser() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group = com.nexaworks.rafiq.entities.Group.builder()
                    .name("User1 Group").description("Belongs to user1").color(Color.RED.name())
    ...
    class AddMedicinesToGroupTests {
        private final String ADD_MEDICINES_ENDPOINT = "/api/v1/group/addMedicines/";
        ...
        void shouldAddMedicinesToGroup_WhenRequestIsValid() throws Exception {
            ...
            com.nexaworks.rafiq.entities.Group group = com.nexaworks.rafiq.entities.Group.builder()
                    .name("Test Group").description("Group for medicines").color(Color.BLUE.name())
                    .patient((Patient) user).build();
    ...
    class RemoveMedicineFromGroupTests {
        private final String REMOVE_MEDICINE_ENDPOINT = "/api/v1/group/removeMedicines/";
        ...
        void shouldReturnNotFound_WhenGroupDoesNotExist() throws Exception {
            ...
            mockMvc.perform(MockMvcRequestBuilders
                    .put(REMOVE_MEDICINE_ENDPOINT + nonExistentGroupId + "/" + medicineId)
                    .with(withUserId(user))).andExpect(MockMvcResultMatchers.status().isNotFound());
        }
