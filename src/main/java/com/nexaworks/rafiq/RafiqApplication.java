...
public class RafiqApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    insertSpecializationIfNotExists(
        "DERM", "Dermatology", "Deals with diseases of the skin, hair, and nails.");
    insertSpecializationIfNotExists(
    ...
    insertSpecializationIfNotExists(
        "OPH", "Ophthalmology", "Deals with eye diseases and vision care.");
    insertSpecializationIfNotExists(
        "GAS", "Gastroenterology", "Focuses on the digestive system and its disorders.");
    insertSpecializationIfNotExists(
        "ONC", "Oncology", "Specializes in cancer diagnosis and treatment.");
    insertSpecializationIfNotExists(
        "NEPH", "Nephrology", "Treats kidney and urinary system disorders.");
    insertSpecializationIfNotExists(
        "PUL", "Pulmonology", "Specializes in lung and respiratory system disorders.");
    insertSpecializationIfNotExists(
        "RHE",
        "Rheumatology",
    ...
    insertSpecializationIfNotExists(
        "GEN", "General Medicine", "Provides general medical care for adults.");
    insertSpecializationIfNotExists(
        "SURG", "Surgery", "Performs surgical procedures for diagnosis and treatment.");
    insertSpecializationIfNotExists(
        "EMER",
        "Emergency Medicine",
