...
public class AuthController {
    ...
    @PostMapping("/logout")
    public ResponseEntity<Void> logout(@RequestBody @Valid LogoutRequest request, HttpServletResponse response) {
    ...
    @PostMapping("/google")
    public ResponseEntity<LoginResponse> oAuth2(@RequestBody OAuthRequest request, HttpServletResponse response)
